...
function AddNEWMedoc({modalOpen,setModalOpen}:any) {
            ...
            <form className='w-full'>
                <div className='flex flex-col gap-6'>
                    <div className="text-sm w-full">
                        ...
                        <textarea className="w-full h-20 mt-2 p-6 text-subMain bg-[#fff] border border-gray-300 rounded" placeholder="Description...">
                        </textarea> 
                    </div>
                    <div className='w-full grid md:grid-cols-2 gap-6'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='w-full text-center'>
                                    <div className='w-full'>
                                        <label
                                            className="flex justify-center h-12  transition text-subMain bg-[#fff] px-6 py-4  border border-gray-300 border-dashed  rounded-md  appearance-none cursor-pointer hover:border-gray-400 focus:outline-none">
                                            <span className="flex items-center space-x-2">
                                                <BsImage className='text-subMain h-8 w-8'/>
                                                <span className="font-medium text-subMain text-center text-[12px] w-48">
                            ...
                            <div className='w-20 h-16 p-2 bg-main border rounded'>
                                <img 
                                src={link}
                                alt=""
                        ...
                        <div className='flex flex-col gap-2'>
                            <div className="text-sm w-full">
                                ...
                                className={`w-full  text-sm  mt-2 p-5 border rounded text-subMain bg-[#fff] h-12 border-gray-300`}/>
                            </div>
                        </div>
                        <div className='flex flex-col gap-2'>
                            <div className="text-sm w-full">
                        ...
                        <div className='flex flex-col gap-2'>
                            <div className="text-sm w-full">
                                <label className="text-subMain font-semibold">Categorie</label>
                                <select className="w-full mt-2 px-6 py-4 text-text bg-main border rounded h-12 border-gray-300">
                                    {CategoriesData.map((option:any,i:number)=>(
