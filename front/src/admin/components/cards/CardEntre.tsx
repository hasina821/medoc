...
export default function CardEntre({medoc}:any){
  ...
  return (
    <>
        ...
        <div className="w-full max-w-full bg-white border border-gray-200 rounded-lg mt-4 shadow-lg hover:shadow-2xl cursor-pointer">
