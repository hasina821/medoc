...
function UpdateSortie({modalOpen,setModalOpen}:any) {
            ...
            <form className='w-full'>
                <div className='flex flex-col gap-6'>
                    <div className="text-sm w-full">
                        ...
                        <textarea className="w-full h-20 mt-2 p-6 text-subMain bg-[#fff] border border-gray-400 rounded" placeholder="Description...">
                        </textarea> 
                    </div>
                    <div className='w-full grid md:grid-cols-2 gap-6'>
                        <div className='flex flex-col gap-2'>
                            ...
                            <div className='w-full text-center'>
                                    <div className='w-full'>
                                        <label
                                            className="flex justify-center h-20  transition text-subMain bg-[#fff] border-2 px-6 py-4  border-gray-400 border-dashed  rounded-md  appearance-none cursor-pointer hover:border-gray-400 focus:outline-none">
                                            <span className="flex items-center space-x-2">
                                                <BsImage className='text-subMain h-24 w-24'/>
                        ...
                        <div className='flex flex-col gap-2'>
                            <div className="text-sm w-full">
                                ...
                                className={`w-full  text-sm  mt-2 p-5 border border-gray-400 rounded text-subMain bg-[#fff] h-20`}/>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" className='bg-subMain transitions hover:bg-dry border border-subMain text-white py-4  rounded w-full  flex-rows gap-6'>
                        <MdUpload/> Ajouter le medicament
                    </button>
                </div>
                </div>
            </form>
